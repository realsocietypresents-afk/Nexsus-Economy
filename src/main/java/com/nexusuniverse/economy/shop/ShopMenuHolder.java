...
public class ShopMenuHolder implements InventoryHolder {
    ...
    public enum Type { CATEGORY_LIST, ITEM_PAGE, CUSTOM_PAGE, ENCHANT_PAGE, NEXUS_ENCHANT_PAGE, ACCESSORY_PAGE, VICE_PAGE, DISEASE_PAGE, POTION_PAGE, SEARCH_RESULTS }
    ...
    /** The category key for ITEM_PAGE, or (repurposed -- there's no "category" to key by) the
     *  raw search text for SEARCH_RESULTS -- see ShopManager#buildSearchResultsPage. */
     ...
     *                 CUSTOM_PAGE/ENCHANT_PAGE/NEXUS_ENCHANT_PAGE/POTION_PAGE, which stay
     *                 one-at-a-time -- see the comment on ShopListener#handleCustomPageClick for why.
     */
