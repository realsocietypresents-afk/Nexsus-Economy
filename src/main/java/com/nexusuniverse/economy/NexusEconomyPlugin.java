...
public class NexusEconomyPlugin extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        this.shopManager = new ShopManager(this, accounts, enchantsBridge, accessoriesBridge);
        this.vitalsManager = new VitalsManager(this, accounts);
        ...
        getServer().getPluginManager().registerEvents(new ShopListener(shopManager, vitalsMenu, accessorySlotsMenu), this);
        getServer().getPluginManager().registerEvents(new AccessorySlotsMenuListener(accessorySlotsMenu, accessoriesBridge, accounts, shopManager), this);
